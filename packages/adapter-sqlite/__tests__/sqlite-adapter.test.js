...
describe('SqliteDatabaseAdapter', () => {
    ...
    beforeEach(() => {
        ...
        adapter = new SqliteDatabaseAdapter(mockDb);
    });
    afterEach(() => {
        vi.clearAllMocks();
    });
    describe('getRoom', () => {
        ...
        it('should return null when room does not exist', async () => {
            ...
            const result = await adapter.getRoom('non-existent-room');
    ...
    describe('getParticipantsForAccount', () => {
        ...
        it('should return empty array when no participants exist', async () => {
            ...
            const result = await adapter.getParticipantsForAccount('no-participants');
    ...
    describe('getParticipantUserState', () => {
        ...
        it('should return user state when it exists', async () => {
            ...
            expect(mockDb.prepare).toHaveBeenCalledWith('SELECT userState FROM participants WHERE roomId = ? AND userId = ?');
    ...
    describe('setParticipantUserState', () => {
        ...
        it('should successfully update user state', async () => {
            ...
            expect(mockDb.prepare).toHaveBeenCalledWith('UPDATE participants SET userState = ? WHERE roomId = ? AND userId = ?');
