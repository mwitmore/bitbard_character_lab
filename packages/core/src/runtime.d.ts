import { type Character, type HandlerCallback, type IAgentRuntime, type ICacheManager, type IDatabaseAdapter, type IMemoryManager, type IRAGKnowledgeManager, ModelProviderName, type Plugin, type Provider, type Adapter, type Service, type ServiceType, type State, type UUID, type Action, type Evaluator, type Memory, type ClientInstance } from "./types.ts";
export declare class AgentRuntime implements IAgentRuntime {
    ...
    composeState(message: Memory, additionalKeys?: {
        [key: string]: unknown;
    }, ragEnabled?: boolean): Promise<State>;
