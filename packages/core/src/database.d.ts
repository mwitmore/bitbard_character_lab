import type { Account, Actor, GoalStatus, Goal, Memory, Relationship, UUID, RAGKnowledgeItem, Participant, IDatabaseAdapter } from "./types.ts";
import { CircuitBreaker } from "./database/CircuitBreaker";
/**
 * An abstract class representing a database adapter for managing various entities
 * like accounts, memories, actors, goals, and rooms.
 */
export declare abstract class DatabaseAdapter<DB = any> implements IDatabaseAdapter {
    /**
