import { formatEvaluatorNames, formatEvaluators, formatEvaluatorExamples, formatEvaluatorExampleDescriptions, } from "../src/evaluators";
...
const mockEvaluators = [
    {
        ...
        similes: [],
        handler: (_runtime, _message, _state, _options, _callback) => {
            throw new Error("Function not implemented.");
        },
        validate: (_runtime, _message, _state) => {
            throw new Error("Function not implemented.");
        },
    },
    {
...
test("formats evaluators correctly", () => {
    ...
    expect(result).toBe("'Evaluator1: This is the first evaluator.',\n'Evaluator2: This is the second evaluator.'");
});
