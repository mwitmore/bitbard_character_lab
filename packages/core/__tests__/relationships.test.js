import { createRelationship, getRelationship, getRelationships, formatRelationships, } from "../src/relationships";
...
describe("Relationships Module", () => {
    ...
    const mockUserA = generateRandomUUID();
    const mockUserB = generateRandomUUID();
    const mockUserId = generateRandomUUID();
    afterEach(() => {
        vi.clearAllMocks();
    });
    describe("createRelationship", () => {
        ...
        it("should handle errors from databaseAdapter", async () => {
            mockDatabaseAdapter.createRelationship.mockRejectedValue(new Error("Database error"));
